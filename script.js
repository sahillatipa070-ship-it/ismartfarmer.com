...
function animalDoctors() {
    let doctors = [
        { name: "Dr. Sharma", distance: 5, status: "Available", phone: "9876543210", rating: 4.5 },
        { name: "Dr. Patel", distance: 12, status: "Busy", phone: "9823456781", rating: 4.2 },
        { name: "Dr. Singh", distance: 8, status: "Available", phone: "9811122233", rating: 4.8 },
        { name: "Dr. Verma", distance: 3, status: "Available", phone: "9898989898", rating: 4.6 },
        { name: "Dr. Reddy", distance: 15, status: "Busy", phone: "9845012345", rating: 4.1 },
        { name: "Dr. Khan", distance: 6, status: "Available", phone: "9833344455", rating: 4.7 },
        { name: "Dr. Mehta", distance: 10, status: "Available", phone: "9800011122", rating: 4.3 },
        { name: "Dr. Iyer", distance: 18, status: "Busy", phone: "9797979797", rating: 3.9 },
        { name: "Dr. Das", distance: 4, status: "Available", phone: "9788887777", rating: 4.9 },
        { name: "Dr. Rao", distance: 1, status: "Available", phone: "9709988776", rating: 5.0 }
    ];

    // Sort by nearest distance
    doctors.sort((a, b) => a.distance - b.distance);

    let html = "<h3>🐄 Nearby Animal Doctors</h3>";
    ...
    doctors.forEach(doc => {
        ...
        html += `
            <div style="margin-bottom:15px; padding:10px; border-radius:8px; box-shadow:0 0 5px #ccc;">
...
function suggestCrop() {
    ...
    let weatherTip = "Ensure proper drainage.";
    let profitTip = "Sell directly in local market.";
    let marketDemand = "Medium";
    let marketPrice = "₹15-30 per kg (varies)";
    let riskLevel = "Medium";
    let irrigation = "Drip irrigation recommended.";
    let diseaseTip = "Regular pest inspection required.";
    let scheme = "Check PM-KISAN support eligibility.";

    if (season === "Kharif" && water === "High") {
        suggestion = "Rice";
        reason = "High water availability suits rice.";
        fertilizer = "Nitrogen-rich fertilizer.";
        yieldEstimate = "4-6 tons per acre";
        weatherTip = "Maintain standing water.";
        profitTip = "Sell at MSP in mandi.";
        marketDemand = "High";
        marketPrice = "₹18-25 per kg";
        riskLevel = "Low";
        irrigation = "Flood irrigation method.";
        diseaseTip = "Watch for leaf blast disease.";
        scheme = "PM Fasal Bima Yojana recommended.";
    } 
    else if (season === "Rabi" && soil === "Loamy") {
        suggestion = "Wheat";
        reason = "Loamy soil is best for wheat.";
        fertilizer = "NPK + Zinc.";
        yieldEstimate = "3-5 tons per acre";
        weatherTip = "Protect from frost.";
        profitTip = "Store crop for better rates.";
        marketDemand = "High";
        marketPrice = "₹20-28 per kg";
        riskLevel = "Low";
        irrigation = "Sprinkler irrigation.";
        diseaseTip = "Prevent rust disease.";
        scheme = "MSP benefit available.";
    } 
    else if (soil === "Black") {
        suggestion = "Cotton";
        reason = "Black soil ideal for cotton.";
        fertilizer = "Potash-rich fertilizer.";
        yieldEstimate = "8-12 quintals per acre";
        weatherTip = "Avoid waterlogging.";
        profitTip = "Track export prices.";
        ...
        scheme = "Subsidy under PM Kusum for irrigation.";
    } 
    else if (water === "Low") {
        suggestion = "Millets";
        reason = "Millets require less water.";
        fertilizer = "Organic compost preferred.";
        yieldEstimate = "1-3 tons per acre";
        weatherTip = "Drought-resistant crop.";
        profitTip = "High demand in health market.";
        marketDemand = "Growing";
        marketPrice = "₹25-40 per kg";
        riskLevel = "Low";
        irrigation = "Minimal irrigation needed.";
        diseaseTip = "Generally pest resistant.";
        scheme = "Millet promotion schemes available.";
    }
    ...
    document.getElementById("cropResult").innerHTML = `
        ...
        <b>📊 Market Demand:</b> ${marketDemand}<br>
        <b>⚠ Risk Level:</b> ${riskLevel}<br>
        <b>💧 Irrigation Method:</b> ${irrigation}<br>
        <b>🦠 Disease Prevention:</b> ${diseaseTip}<br>
        <b>🏛 Suggested Scheme:</b> ${scheme}<br><br>

        <b>🌦 Weather Advice:</b> ${weatherTip}<br>
        <b>📈 Profit Tip:</b> ${profitTip}
    `;
}
...
function getAIResponse() {
    ...
    if (question === "") {
        answer = "⚠ Please enter your question first.";
    }
    else if (question.includes("wheat")) {
        answer = "🌾 Wheat grows best in loamy soil during Rabi season. Use balanced NPK fertilizer.";
    }
    else if (question.includes("rice")) {
        answer = "🌾 Rice needs high water supply. Best for Kharif season.";
    }
    else if (question.includes("fertilizer")) {
        answer = "🧪 Use organic compost or NPK 10-26-26 depending on soil test.";
    }
    else if (question.includes("pest") || question.includes("aphid")) {
        answer = "🐛 Spray neem oil every 7 days to control pests naturally.";
    }
    else if (question.includes("milk")) {
        answer = "🥛 Increase milk production by providing balanced cattle feed and clean water.";
    }
    else if (question.includes("weather")) {
        answer = "🌦 Check weather before irrigation. Avoid spraying during rainfall.";
    }
    else if (question.includes("profit")) {
        answer = "💰 Increase profit by reducing input cost and checking mandi prices before selling.";
    }
    else if (question.includes("cotton")) {
        answer = "🌱 Cotton grows best in black soil with moderate rainfall.";
    }
    else if (question.includes("government")) {
        answer = "🏛 Check schemes like PM-KISAN and crop insurance for support.";
    }
    else {
        answer = "🤖 Sorry, I am still learning. Please ask about crops, fertilizer, pests, milk, weather, or profit.";
    }
